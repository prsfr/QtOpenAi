...
void TestVectorStoresClient::createPostsJsonBody()
{
    ...
    const auto reply = awaited(client.createVectorStore(request));
    QVERIFY(reply);
...
void TestVectorStoresClient::listSendsPaginationQuery()
{
    ...
    const auto reply = awaited(client.listVectorStores(params));
    QVERIFY(reply);
...
void TestVectorStoresClient::getParsesStore()
{
    ...
    const auto reply = awaited(client.getVectorStore(QStringLiteral("vs_1")));
    QVERIFY(reply);
...
void TestVectorStoresClient::updatePostsChangedFieldsOnly()
{
    ...
    const auto reply = awaited(client.updateVectorStore(QStringLiteral("vs_1"), request));
    QVERIFY(reply);
...
void TestVectorStoresClient::deleteIssuesDeleteVerb()
{
    ...
    const auto reply = awaited(client.deleteVectorStore(QStringLiteral("vs_1")));
    QVERIFY(reply);
...
void TestVectorStoresClient::createFilePostsFileId()
{
    ...
    const auto reply = awaited(client.createVectorStoreFile(
...
void TestVectorStoresClient::updateFileAttributesPostsAttributes()
{
    ...
    const auto reply = awaited(client.updateVectorStoreFileAttributes(
            QStringLiteral("vs_1"), QStringLiteral("file-1"),
...
void TestVectorStoresClient::createFileBatchPostsFileIds()
{
    ...
    const auto reply = awaited(client.createVectorStoreFileBatch(
...
void TestVectorStoresClient::listBatchFilesUsesBatchPath()
{
    ...
    ListParams params;
    params.limit = 10;
    const auto reply = awaited(client.listVectorStoreFileBatchFiles(
...
void TestVectorStoresClient::searchParsesRankedResults()
{
    ...
    const auto reply = awaited(client.searchVectorStore(QStringLiteral("vs_1"), request));
    QVERIFY(reply);
